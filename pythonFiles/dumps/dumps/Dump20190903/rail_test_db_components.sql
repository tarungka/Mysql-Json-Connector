...
CREATE TABLE `components` (
  ...
  `if_kit` tinyint(1) DEFAULT '0',
  `associated_colour` varchar(20) NOT NULL,
  `number_of_times_issued` int(10) unsigned DEFAULT '0',
  `group` varchar(15) NOT NULL,
  `component_status(if issued)` tinyint(1) DEFAULT '0',
  `most_recent_issue` datetime DEFAULT NULL,
  `total_time_of_use` varchar(20) DEFAULT NULL,
